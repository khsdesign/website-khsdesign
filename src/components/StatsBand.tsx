import bandBg from "../assets/stats-band-bg.png";
...
export const StatsBand = () => {
  ...
  return (
    <section className="relative w-full" style={{ height: v("75px", "109px", "149px") }}>
      ...
      <div
        className="relative h-full flex items-center justify-around text-white"
        style={{ paddingLeft: v("20px", "40px", "80px"), paddingRight: v("20px", "40px", "80px") }}
      >
        <div className="flex items-center" style={{ gap: itemGap }}>
          <img src={iconCustomer} alt="" style={{ width: iconSize, height: iconSize, flexShrink: 0 }} />
        ...
        <div className="flex items-center" style={{ gap: itemGap }}>
          <img src={iconSupport} alt="" style={{ width: iconSize, height: iconSize, flexShrink: 0 }} />
          <div className="leading-tight" style={{ fontSize: textSize }}>
            <p>200+</p>
            <p>Proiecte</p>
          </div>
        ...
        <div className="flex items-center" style={{ gap: itemGap }}>
          <img src={iconExperience} alt="" style={{ width: iconSize, height: iconSize, flexShrink: 0 }} />
          <div className="leading-tight" style={{ fontSize: textSize }}>
            <p>20+ Ani</p>
            <p>Experiență</p>
          </div>
